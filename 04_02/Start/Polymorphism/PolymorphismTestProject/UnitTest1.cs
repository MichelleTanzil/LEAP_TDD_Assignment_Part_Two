...
namespace PolymorphismTestProject
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void CalculateWeeklySalaryForEmployeeTest_70wage55hoursDoesNotReturns2800Dollars()
        {
            //Arrange
            int weeklyHours = 55;
            int wage = 70;
        ...
        [TestMethod]
        public void CalculateWeeklySalaryForContractorTest_70wage55hoursDoesNotReturns2800Dollars()
        {
            //Arrange
            int weeklyHours = 55;
            int wage = 70;
